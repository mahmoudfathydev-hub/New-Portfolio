        ...
        <div className="flex flex-col items-center justify-center projects-section py-20 px-6 max-w-7xl mx-auto">
            <div className="section-title text-center mb-16" data-aos="fade-down">
                <h2 className="text-4xl md:text-5xl font-bold text-white tracking-tight">
                    My <span className="text-[#e99b63] [text-shadow:_0_0_10px_rgba(233,155,99,0.3)]">Projects</span>
                </h2>
            </div>
                    ...
                    return (
                        ...
                        >
                            ...
                            <div className="project-info p-6 flex flex-col flex-grow">
                                <h2 data-aos="fade-left" className="flex items-center justify-center text-2xl font-bold text-white mb-3 group-hover:text-[#e99b63] transition-colors">{project.name}</h2>
                                <p data-aos="fade-right" className="text-white/70 text-sm leading-relaxed mb-6 line-clamp-3">{project.desc}</p>
                                <div
