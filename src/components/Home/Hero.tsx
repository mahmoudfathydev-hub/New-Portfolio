        ...
        >
            <div data-aos="fade-right"
                ...
                <p className="text-base sm:text-lg tracking-wider text-gray-400 max-w-[35rem]">
                    As a Front-end Developer, I craft interactive, responsive, and visually
                    stunning websites using React, Vite, and modern web technologies.
                </p>

                <div className="flex items-center gap-4 mt-10">
                    <Link
                        to="/projects"
                        className="flex items-center gap-2 border border-[#2a2a2a] py-2 sm:py-3 px-4 sm:px-5 text-sm sm:text-lg font-semibold rounded-full tracking-wider transition-all duration-300 hover:bg-[#1a1a1a]"
                    >
                        <FaCode />
                        Projects
                    </Link>
